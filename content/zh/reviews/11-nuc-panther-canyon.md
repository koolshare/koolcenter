...
---
title: "处处不同——11代NUC 猎豹峡谷 Panther Canyon 开箱拆解评测"
linkTitle: "处处不同——11代NUC 猎豹峡谷 Panther Canyon 开箱拆解评测"
author: "pufer"
...
猎豹峡谷同样也搭载了两个ThunderBolt，但是变成了一个前置一个后置的配置，更加方便使用，同时支持9V输出。视频输出部分是HDMI 2.1+miniDP 1.4的组合，更加实用。同时，猎豹峡谷顶盖支持Qi 15W无线充电，手机充电会非常方便。

**【开箱】**

工程机的白色包装，上面标注型号NUC11PAQi7，这台是i7版本的猎豹峡谷。
...
拆解从底部动手，打开后可以看到内部，底盖上的2.5寸盘位和主板之间用软排线连接。
...
性能测试中我们给猎豹峡谷配备了内存和SSD

内存使用了三星 DDR4-3200 SODIMM 16G x2
...
设备按连接顺序显示。同时在ThunderBolt接口上连接了Promise Sanlink3 N1万兆网卡，可以看到ThunderBolt设备的连接。
...
Intel核心显卡在视频解码方面一直非常强大，这次XE核显更加强大。

DVXA Checker硬件解码检测，HEVC(x265)，VP9，AV1 8K 10bit完整支持，无论蓝光原盘，还是在线视频，都可以做到完美的硬解。
...
测试平台：       Windows 10 Pro Workstation Version 20H2 64-bit

测试软件：       7-Zip 20.02 - 64bit

                       AIDA64 Extreme 6.30.5523
...
这一代的XE核显3D性能也有了比较大的进步，普通单机游戏和主流网游在合适的分辨率和画质下还是可以一战的。
...
11代处理器支持了2.5G网口，所以这次也做个2.5G LAN的samba读写测试。
...
主频维持在4.1Ghz，温度最终稳定在60度，核心功耗26.61W
...
刚开始，主频维持在4.0Ghz，温度最终稳定在95度，核心功耗56.56W
...
主频稳定在2.8Ghz，温度最终稳定在49度，核心功耗23.64W
